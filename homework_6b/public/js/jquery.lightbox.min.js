...
document.body&&(e=document.body.clientWidth,h=document.body.clientHeight);pageHeight=b<h?h:b;pageWidth=a<e?a:e;return arrayPageSize=[pageWidth,pageHeight,e,h]}function p(a){var b=new Date;do var e=new Date;while(e-b<a)}a=jQuery.extend({overlayBgColor:"#000",overlayOpacity:.8,fixedNavigation:!1,imageLoading:lightbox_path+"assets/lightbox-ico-loading.gif",imageBtnPrev:lightbox_path+"assets/lightbox-btn-prev.gif",imageBtnNext:lightbox_path+"assets/lightbox-btn-next.gif",imageBtnClose:lightbox_path+"assets/lightbox-btn-close.gif",
